                        ...
                        <div class="card rounded-0 border-0 shadow">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6 content">
                                    ...
                                    <a href="{{ url('/cars') }}" class="btn product-buttons" data-toggle="modal" data-target="#exampleModal">Apply Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card rounded-0 border-0 shadow">
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-md-6 content">
                                    ...
                                    <a href="#" class="btn product-buttons" data-toggle="modal" data-target="#exampleModal">Apply Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
